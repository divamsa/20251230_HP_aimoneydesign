...
class DownloadRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'requested_materials' => ['required', 'array', 'min:1'],
            'requested_materials.*' => ['string', 'max:255'],
    ...
    public function messages(): array
    {
        return [
            ...
            'requested_materials.required' => '希望資料を選択してください。',
            'requested_materials.min' => '希望資料を1つ以上選択してください。',
